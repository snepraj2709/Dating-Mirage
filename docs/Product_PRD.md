...
Consistency (CON): Erratic/Hot-and-Cold (1.0) $\leftrightarrow$ Steady/Predictable (10.0)

Intensity (INT): Slow-Burn (1.0) $\leftrightarrow$ High-Speed Whirlwind (10.0)

Autonomy (AUT): Enmeshed/Codependent (1.0) $\leftrightarrow$ Fiercely Independent (10.0)

Validation-Seeking (VAL): Character-Driven (1.0) $\leftrightarrow$ Status/Trophy-Driven (10.0)

Growth/Comm (GOC): Avoidant/Silent (1.0) $\leftrightarrow$ Confronts/Processes (10.0)

Vulnerability (VUL): Guarded/Mysterious (1.0) $\leftrightarrow$ Open/Raw (10.0)

Reactivity (REA): Emotionally Sovereign (1.0) $\leftrightarrow$ Absorbs Partner's Mood (10.0)

Relational Worth (RWO): Accommodates/Settles (1.0) $\leftrightarrow$ Firm Boundaries (10.0)

2. Feature Specifications: The 4-Step Journey

Phase 1: User Step 1 — "Who I Say I Want" (The Ideal)

Objective: Capture the user's aspirational dating profile ($I_d$ Vector) without triggering cognitive fatigue or numerical bias.
UX Mechanism: "Vivid Anchors" Continuous Sliders.
...
Objective: Capture the user's actual behavioral history ($A_d$ Vector).
UX Mechanism: Swipe Matrix (16 Cards).
...
Objective: Gather brutal, ground-truth data from the user's social circle ($S_d$ Vector) with zero onboarding friction.
UX Mechanism: Web-based "This or That" Rapid-Fire Deck.
...
Objective: Synthesize the 3 vectors ($I_d, A_d, S_d$) into a personalized, highly shareable diagnostic card.
Algorithm Logic:
